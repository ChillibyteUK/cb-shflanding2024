...
function widgets_init()
{
    ...
    register_nav_menus(array(
        'primary_nav' => __('Primary Nav', 'cb-shflanding2024'),
        'footer_menu_1' => __('Footer Services', 'cb-shflanding2024'),
        'footer_menu_2' => __('Footer Guides', 'cb-shflanding2024'),
        'footer_menu_3' => __('Footer About', 'cb-shflanding2024'),
    ));
